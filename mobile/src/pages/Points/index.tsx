...
const Points = () => {
    ...
    useEffect(() => {
        async function loadPosition() {
            ...
            if (status !== 'granted') {
                Alert.alert('Oooops...', 'Precisamos de sua permição para obter sua localização');
                return;
            }
                ...
                <ScrollView
                    ...
                    {items.map(item => (
                        <TouchableOpacity
                            ...
                            style={[
                                styles.item,
                                selectedItems.includes(item.id) ? styles.selectedItem : styles.item
                            ]}
                            onPress={() => { handleSeletcItem(item.id) }}>
